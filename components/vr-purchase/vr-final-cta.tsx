                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-5">
                            ...
                            <Link
                                ...
                                className="group inline-flex items-center gap-3 px-8 py-5 rounded-full border border-primary/30 bg-primary/10 backdrop-blur-md text-secondary-600 font-medium hover:bg-primary hover:text-primary-foreground transition-all duration-300 shadow-lg hover:shadow-primary/30"
                            >
